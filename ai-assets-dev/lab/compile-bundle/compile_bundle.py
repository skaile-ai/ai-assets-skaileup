#!/usr/bin/env python3
"""compile_bundle.py — sync co-located *.bundle.yaml from *.flow.yaml.
...
Run from repo root:
  python ai-assets/lab/compile-bundle/compile_bundle.py
...
def main(
    ...
    bundles = load_bundles(flows_dir)
