#!/usr/bin/env python3
"""validator.py — walkthrough-mockup-static-html validator.
...
2. **Fixture mode**: in addition to structural checks, byte-compare every
   ...
   `walkthrough-mockup/static-html/tests/expected/<fixture>/`.
...
class Report:
    ...
    def print_and_exit(self) -> None:
        if self.ok():
            print("PASS — walkthrough-mockup-static-html validator")
            sys.exit(0)
        print(
            f"FAIL — walkthrough-mockup-static-html: "
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="validator.py",
        description="walkthrough-mockup-static-html validator",
    )
