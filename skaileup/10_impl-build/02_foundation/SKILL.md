...
and layout patterns come from `09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md`.
...
09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md — css_vars_mapping, auth_setup, app_shell recipes
...
`09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md` and extract:
