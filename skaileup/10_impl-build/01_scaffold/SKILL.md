...
| Must read      | `09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md` | Yes (resolved from stack.md) |
...
09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md — scaffold commands + project structure
...
- Read profile: `09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md`
