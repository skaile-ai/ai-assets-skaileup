...
- Read `09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md` and extract `mock_template:`
...
| `09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md` | Optional (read if stack.md has tech_stack_skill) |
...
1. **Auto-select (preferred):** If `_concept/blueprint/techstack.md` exists:
   ...
   - Read `09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md`, extract `mock_template:`
