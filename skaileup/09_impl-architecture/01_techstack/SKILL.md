...
description: "Use when the project brief exists and tech stack hasn't been chosen. Discovers available stacks from 09_impl-architecture/templates/, asks plain-language questions, recommends the best match, and writes stack.md."
metadata:
  version: '1.0.0'
  stage: alpha
  tags:
...
available stacks at runtime from `09_impl-architecture/templates/*/TEMPLATE.md` and recommends
...
| Must read        | `09_impl-architecture/templates/*/TEMPLATE.md`                        | Yes (stack discovery)            |
...
09_impl-architecture/templates/_/TEMPLATE.md — available stack profiles (discovered at runtime)
...
MUST discover available stacks from 09_impl-architecture/templates/ at runtime — never hardcode
...
- Scan 09_impl-architecture/templates/\*/TEMPLATE.md
...
- [ ] 09_impl-architecture/templates/ was scanned for available stacks
- [ ] stack.md exists with all required frontmatter fields
- [ ] tech_stack_skill field is set (matches a 09_impl-architecture/templates/ directory or "custom")
...
| ------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Hardcoding stack details without reading profiles | Always scan 09_impl-architecture/templates/\*/TEMPLATE.md — new profiles may have been added. |
