...
All naming follows `contracts/golden_principles.md`.
...
Use semantic types from `contracts/semantic_types.md`. Never use SQL types.
...
See `contracts/seed_data.md` for the authoritative format.
