...
description: 'Use after screens are approved to generate a 3-layer Storybook project: custom building-block components, full-page screen compositions, and clickable user journey flows. Framework-agnostic — resolves addon and story format from 09_impl-architecture/templates/. Delegates to 4 sub-skills in sequence.'
metadata:
  version: '1.0.0'
  stage: alpha
  tags:
...
(`09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md`).
...
09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md — storybook_addon, story_format, component_library, icon_library
...
- Read 09_impl-architecture/templates/<tech_stack_skill>/TEMPLATE.md → extract:
  | Field | Purpose |
  |---|---|
