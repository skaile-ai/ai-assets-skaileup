  ...
  prerequisites:
    inputs_required:
      - id: bug_description
        ...
        type: textarea
        hint: "1-3 sentences. What does the user observe vs. what they expected."
      - id: repro_steps
        label: "Reproduction steps"
        type: textarea
        hint: "Numbered steps, or 'intermittent — see notes' if not reliable."
    inputs_optional:
      - id: hypothesis
        label: "Current hypothesis (if any)"
        type: textarea
        hint: "1-3 sentences. State confidence: low / medium / high. Leave empty if you have none."
      - id: bug_id
    ...
    produces:
      - path: "_debug/<id>/protocol.md"
        description: "Self-runnable verification protocol — commands + expected outputs + pass criteria"
      - path: "_debug/<id>/context.md"
