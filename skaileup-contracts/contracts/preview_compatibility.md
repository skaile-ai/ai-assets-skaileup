...
> **Audience:** authors of stack profiles in `skaileup-quality/profiles/` and
> AI agents running the `skaileup-build-scaffold` / `skaileup-build-foundation`
> skills.
> **Used by:** every `skaileup-tech-stack-*` profile that targets a web
...
When writing or updating a `skaileup-tech-stack-*` profile that targets a
