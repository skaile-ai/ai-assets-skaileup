...
:::note[Flow manifest]
**Flow:** [`skaileup/flows/standard-app/standard-app.flow.yaml`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/flows/standard-app/standard-app.flow.yaml)
**Bundle:** [`skaileup/flows/standard-app/standard-app.bundle.yaml`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/flows/standard-app/standard-app.bundle.yaml)
:::
