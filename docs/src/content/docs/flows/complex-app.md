...
:::note[Flow manifest]
**Flow:** [`skaileup/flows/complex-app/complex-app.flow.yaml`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/flows/complex-app/complex-app.flow.yaml)
**Bundle:** [`skaileup/flows/complex-app/complex-app.bundle.yaml`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/flows/complex-app/complex-app.bundle.yaml)
:::
