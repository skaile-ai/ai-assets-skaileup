...
:::note[Flow manifest]
**Flow:** [`skaileup/flows/impl-slice/impl-slice.flow.yaml`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/flows/impl-slice/impl-slice.flow.yaml)
**Bundle:** [`skaileup/flows/impl-slice/impl-slice.bundle.yaml`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/flows/impl-slice/impl-slice.bundle.yaml)
:::
