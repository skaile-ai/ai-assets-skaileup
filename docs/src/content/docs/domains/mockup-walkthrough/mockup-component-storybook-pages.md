...
**Source:** [`skaileup/mockup-walkthrough/storybook/pages/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/mockup-walkthrough/storybook/pages/SKILL.md)
:::
