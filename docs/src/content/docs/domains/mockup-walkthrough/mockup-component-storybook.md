...
**Source:** [`skaileup/mockup-walkthrough/storybook/orchestrator/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/mockup-walkthrough/storybook/orchestrator/SKILL.md)
:::
