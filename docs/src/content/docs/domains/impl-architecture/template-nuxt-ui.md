...
sidebar:
  label: "template-nuxt-ui"
---

:::note[Skill manifest]
**Name:** `template-nuxt-ui`
**Stage:** alpha · **Version:** —
**Tags:** nuxt, nuxt-ui, reka-ui, radix-vue, directus, postgresql, ssr, vue3, tailwind, bun, consumer, branded, design-forward
**Source:** [`skaileup/impl-architecture/templates/template-nuxt-ui/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/impl-architecture/templates/template-nuxt-ui/SKILL.md)
:::
