...
sidebar:
  label: "template-nuxt-minimal"
---

:::note[Skill manifest]
**Name:** `template-nuxt-minimal`
**Stage:** alpha · **Version:** —
**Tags:** nuxt, tailwind, drizzle, sqlite, nitro, nuxt-auth-utils, bun, minimal, personal, blog, tool, prototype, learning
**Source:** [`skaileup/impl-architecture/templates/template-nuxt-minimal/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/impl-architecture/templates/template-nuxt-minimal/SKILL.md)
:::
