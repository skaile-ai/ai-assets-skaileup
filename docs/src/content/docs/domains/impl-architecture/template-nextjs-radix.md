...
**Source:** [`skaileup/impl-architecture/templates/template-nextjs-radix/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/impl-architecture/templates/template-nextjs-radix/SKILL.md)
:::
