...
sidebar:
  label: "template-nuxt-primevue"
---

:::note[Skill manifest]
**Name:** `template-nuxt-primevue`
**Stage:** alpha · **Version:** —
**Tags:** nuxt, primevue, directus, postgresql, ssr, vue3, tailwind, bun, saas, dashboard, admin, crm
**Source:** [`skaileup/impl-architecture/templates/template-nuxt-primevue/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/impl-architecture/templates/template-nuxt-primevue/SKILL.md)
:::
