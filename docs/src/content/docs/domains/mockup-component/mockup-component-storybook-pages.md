---
title: "mockup-component-storybook-pages"
description: "Use when building-block components are ready and full-page screen compositions are needed. Sub-skill 3/4: builds AppShell and page stories from screen specs with all state variants and responsive viewports; writes manifest.json for the journeys sub-s"
sidebar:
  label: "mockup-component-storybook-pages"
---

:::note[Skill manifest]
**Name:** `mockup-component-storybook-pages`
**Stage:** alpha · **Version:** 1.0.0
**Tags:** storybook, pages, screens, compositions, app-shell, states, responsive
**Source:** [`skaileup/mockup-component/storybook/pages/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/mockup-component/storybook/pages/SKILL.md)
:::
