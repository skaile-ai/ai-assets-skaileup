...
sourcePath: "skaileup/concept/grounding/onboard/SKILL.md"
sidebar:
...
IF user chose standard or thorough: > "The preset applies default depths to each pipeline domain. Would you like to > adjust any domain individually? (Skip to use all defaults)"
    ...
    IF user wants overrides:
      ...
      | mockup-walkthrough    | <preset value>        |           |
      | mockup-component-storybook    | <preset value>        |           |
...
`yaml
    ...
    tier_overrides:
      ...
      mockup-walkthrough: "<none|light|medium|max>"
      mockup-component-storybook: "<none|light|medium|max>"
...
| mockup-walkthrough    | none  | light    | medium   |
| mockup-component-storybook    | none  | none     | max      |
