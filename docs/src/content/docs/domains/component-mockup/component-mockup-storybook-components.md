...
**Source:** [`mockup-component/storybook/components/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/mockup-component/storybook/components/SKILL.md)
:::
