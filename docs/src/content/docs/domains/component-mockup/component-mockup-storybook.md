...
**Source:** [`mockup-component/storybook/orchestrator/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/mockup-component/storybook/orchestrator/SKILL.md)
:::
