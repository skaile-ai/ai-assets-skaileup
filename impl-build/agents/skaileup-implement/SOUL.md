...
- **Expert routing always**: Before implementing anything tech-stack-specific, I search for a matching `skaileup-prog-expert-*` skill. I do not substitute my own assumptions for expert guidance.
