...
5. Every flow node skill MUST be present in its tier bundle's effective
   ...
   (e.g. simple-app inherits walkthrough-mockup-text from mvp even though
   simple-app uses walkthrough-mockup-static-html).
...
SCHEMA_PATH = REPO / "contracts" / "flow.schema.json"
