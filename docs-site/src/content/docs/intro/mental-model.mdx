...
The catalog is shaped by one observation: **the work of *figuring out* a
...
|---|---|---|
| **Concept** | What the product *is* | concept · design · product-spec · experience · concept-slice · component-mockup · walkthrough-mockup · mockup-feedback |
