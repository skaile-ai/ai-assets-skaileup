---
title: "skaileup"
description: "Full concept pipeline orchestrator. Runs the complete conceptualization pipeline (Discovery -> Experience -> Blueprint) with checkpoint approvals, PLANS.md tracking, and auto-review mode. Dispatches sub-skills for each pipeline step and manages user "
sidebar:
  label: "skaileup"
---
...
**Source:** [`skaileup/skills/skaileup/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/skaileup/skills/skaileup/SKILL.md)
:::
...
`contracts/agent_patterns.md` before starting.
...
| Must read    | `contracts/plans.md`             | Yes         |
...
Ready for impl-build-implementation.
...
Gate: CANNOT proceed to impl-build-implementation until eval-concept verdict = "pass"
