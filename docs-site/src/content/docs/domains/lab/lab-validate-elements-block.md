...
**Source:** [`lab/validate-elements-block/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/lab/validate-elements-block/SKILL.md)
:::
