...
**Source:** [`concept/grounding/research/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/concept/grounding/research/SKILL.md)
:::
...
\_grounding/step/{step}/_.md — step-specific research when dispatched alongside a skill
