...
**Stage:** — · **Version:** —
**Tags:** —
**Source:** [`ops/project-subsystem-map/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/ops/project-subsystem-map/SKILL.md)
:::
