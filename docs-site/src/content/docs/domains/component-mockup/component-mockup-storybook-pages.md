---
title: "component-mockup-storybook-pages"
...
sidebar:
  label: "storybook-pages"
---

:::note[Skill manifest]
**Name:** `component-mockup-storybook-pages`
**Stage:** — · **Version:** 1.0.0
**Tags:** storybook, pages, screens, compositions, app-shell, states, responsive
**Source:** [`component-mockup/storybook/pages/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/component-mockup/storybook/pages/SKILL.md)
:::
