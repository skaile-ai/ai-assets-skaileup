...
description: "Generates database migrations from the data model. Reads model.dbml + model.json and stack.md, then generates migration files for the target ORM (Prisma, Drizzle, Directus, raw SQL). Translates semantic types using contracts/semantic_types.md. Run be"
sidebar:
  label: "migrate"
---
...
**Source:** [`impl-build/migrate/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/impl-build/migrate/SKILL.md)
:::
