---
title: "walkthrough-mockup-astro"
...
**Source:** [`walkthrough-mockup/astro/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/walkthrough-mockup/astro/SKILL.md)
:::
...
Run from `_concept/walkthrough-mockup/astro/`:
...
```bash
python walkthrough-mockup/astro/validator.py _concept/walkthrough-mockup/astro
```
