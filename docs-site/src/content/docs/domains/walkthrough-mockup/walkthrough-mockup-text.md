...
:::note[Skill manifest]
**Name:** `walkthrough-mockup-text`
**Stage:** — · **Version:** 1.0.0
**Tags:** ui, ux, design, frontend, mockups, prototype, linked, alpine, shoelace, primevue, vue3, preact, htm
**Source:** [`walkthrough-mockup/text/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/walkthrough-mockup/text/SKILL.md)
:::
