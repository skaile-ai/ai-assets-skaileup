...
**Source:** [`impl-architecture/templates/template-postxl/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/impl-architecture/templates/template-postxl/SKILL.md)
:::
