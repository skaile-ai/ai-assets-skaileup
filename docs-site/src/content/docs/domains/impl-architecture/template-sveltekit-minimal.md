...
**Source:** [`impl-architecture/templates/template-sveltekit-minimal/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/impl-architecture/templates/template-sveltekit-minimal/SKILL.md)
:::
