...
**Source:** [`impl-architecture/templates/template-nuxt-ui/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/impl-architecture/templates/template-nuxt-ui/SKILL.md)
:::
