...
**Source:** [`impl-architecture/datamodel/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/impl-architecture/datamodel/SKILL.md)
:::
...
`contracts/semantic_types.md`, `contracts/golden_principles.md`,
`contracts/feedback_loop.md`, and `contracts/seed_data.md`.
...
contracts/semantic_types.md — stack-independent field type catalog
contracts/golden_principles.md — naming rules: snake_case fields, PascalCase enums, \_id suffix
contracts/feedback_loop.md — cross-reference protocol (features ↔ datamodel)
contracts/seed_data.md — scenario format and data quality rules
references/model_conventions.md — DBML + model.json template, naming rules, feature_map format

MUST use semantic types from contracts/semantic_types.md — not SQL types
...
- Read contracts/seed_data.md for scenario format and quality rules
...
See contracts/seed_data.md for full format and examples.
