...
**Source:** [`impl-architecture/templates/template-nuxt-primevue/SKILL.md`](https://github.com/skaile-ai/ai-assets-skaileup/blob/main/impl-architecture/templates/template-nuxt-primevue/SKILL.md)
:::
