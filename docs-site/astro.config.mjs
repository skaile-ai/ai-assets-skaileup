      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "component-mockup",
              autogenerate: { directory: "domains/component-mockup" },
              collapsed: true,
            },
            {
              label: "walkthrough-mockup",
              autogenerate: { directory: "domains/walkthrough-mockup" },
              collapsed: true,
            },
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "skaileup",
              autogenerate: { directory: "domains/skaileup" },
              collapsed: true,
            },
            {
              label: "ops",
